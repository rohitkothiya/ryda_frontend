    ...
    <main className={classes.main}>
      ...
      <Paper className={classes.paper}>
        ...
        <FormControl margin="normal" required fullWidth>
            ...
            <Input id="name" name="nameRegister" autoComplete="name" autoFocus onChange={this.handleChangeInputText} defaultValue="rohit"/>
          </FormControl>
          <FormControl margin="normal" required fullWidth>
          ...
          <FormControl margin="normal" required fullWidth>
            ...
            <Input name="passwordRegister" type="password" id="password" autoComplete="current-password" onChange={this.handleChangeInputText} defaultValue="123" />
          </FormControl>
          <FormControl margin="normal" required fullWidth>
