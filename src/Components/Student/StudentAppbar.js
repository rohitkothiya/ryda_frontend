  ...
  return (
    <div className={classes.root}>
      <AppBar position="static">
        <Toolbar>
          <IconButton className={classes.menuButton} color="inherit" aria-label="Menu" onClick={this.handleProfile}>
            <MenuIcon />
          </IconButton>
        ...
        <FormControl margin="normal" required fullWidth>
            ...
            <Input id="name" name="nameRegister" autoComplete="name" autoFocus />
          </FormControl>
          <FormControl margin="normal" required fullWidth>
          ...
          <FormControl margin="normal" required fullWidth>
            ...
            <Input name="ageRegister" type="number" id="age" autoComplete="current-password" />
          </FormControl>
          <FormControl margin="normal" required fullWidth>
            <InputLabel htmlFor="eduction"> Higher Eduction</InputLabel>
            <Input name="eductionRegister" type="text" id="eduction" autoComplete="current-password"  />
          </FormControl>
          <DialogActions>
